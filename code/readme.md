...
- При клике на контакте открывается меню, в котором можно включить/отключить оповещение, удалить пользователя из списка контактов, удалить переписку с контактом.
